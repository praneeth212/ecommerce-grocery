...
public class AddressService {
    ...
    public List<Address> setDefaultAddress(Long userId, Long addressId) {
        addressRepository.updateDefaultAddressToFalse(userId); // all addresses default_address = false
        Address address = addressRepository.findById(addressId).orElseThrow(() -> new RuntimeException(s));
        address.setDefault_address(true); // specific address default_address = true
