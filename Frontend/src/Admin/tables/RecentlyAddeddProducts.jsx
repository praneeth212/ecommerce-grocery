...
import {beveragedata} from '../../Data/Bevarages/bevaragedata'
  ...
  return (
    <Card>
       <CardHeader
          ...
          action={<Typography onClick={()=>navigate("/admin/products")} variant='caption' sx={{color:"Yellow",cursor:"pointer",paddingRight:".8rem"}}>View All</Typography>}
    ...
    <TableContainer>
      <Table sx={{ minWidth: 800 }} aria-label='table in dashboard'>
        ...
        <TableBody>
          {beveragedata.slice(0,5).map(item => (
